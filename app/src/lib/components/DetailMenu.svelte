...
<div id="toast" class="toast opacity-{toastShow} suit-font" bind:this={toastArea}>
...
<div class="flex justify-between items-center p-3">
    ...
    <div>
        {#if favorateBool}
            <button class="cursor-pointer" value="unfav" on:click={favorateAct}>
                <svg
                    width="24"
                    height="24"
                    fill="#FF4848"
        ...
        {:else}
            <button class="cursor-pointer" value="fav" on:click={favorateAct}>
                <svg
                    width="24"
                    height="24"
                    fill="#8C8C8C"
